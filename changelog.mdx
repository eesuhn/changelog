...
<Update label="November 2023">
  ...
  * [/coins/\{contract}/contract/\{contract\_address}](/reference/coins-contract-address)

  This addition allows users to accurately link to a CoinGecko coin page using [www.coingecko.com/en/\{web\_slug}](http://www.coingecko.com/en/\{web_slug}).
...
<Update label="March 2023">
  ...
  * [/nfts/\{id}](/reference/nfts-id)
  * [/nfts/\{asset\_platform}/contract/\{contract\_address}](/reference/nfts-contract-address)
...
<Update label="September 2022">
  ...
  * [/token\_lists/\{asset\_platform\_id}/all.json](/reference/token-lists)
  ...
  We have added a new field, "details\_platform," to the [/coins/\{id}](/reference/coins-id) and [/coins/\{asset\_platform\_id}/contract/\{contract\_address}](/reference/coins-contract-address) endpoints responses. 
